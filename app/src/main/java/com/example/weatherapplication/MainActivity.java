...
public class MainActivity extends AppCompatActivity {
    ...
    private void getWeatherInfo(String cityName){
        String url = "http://api.weatherapi.com/v1/forecast.json?key=f12cc6b60f3243738a6222628241404&q="+cityName+"&days=1&aqi=no&alerts=no";
        cityNameTV.setText(cityName);
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    if(isDay==1){
                        Picasso.get().load("https://e0.pxfuel.com/wallpapers/734/488/desktop-wallpaper-tropical-beach-sea-sunny-day-blue-sky-nature-iphone-6-plus-background-23704.jpg").into(backIV);
                    }else{
